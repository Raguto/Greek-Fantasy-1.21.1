...
public class StaffOfHealingItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(final Level world, final Player player, final InteractionHand hand) {
        ...
        if (!player.isCreative()) {
            stack.hurtAndBreak(GreekFantasy.CONFIG.STAFF_OF_HEALING_DURABILITY_ON_USE.get(), player, hand == InteractionHand.MAIN_HAND ? EquipmentSlot.MAINHAND : EquipmentSlot.OFFHAND);
        }
