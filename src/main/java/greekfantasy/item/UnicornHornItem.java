...
public class UnicornHornItem extends Item {
    ...
    public ItemStack finishUsingItem(final ItemStack stack, final Level worldIn, final LivingEntity entityLiving) {
        ...
        if (GreekFantasy.CONFIG.UNICORN_HORN_CURES_EFFECTS.get()) {
            ...
            Set<net.minecraft.core.Holder<MobEffect>> negativeEffects = new HashSet<>();
            ...
            for(net.minecraft.core.Holder<MobEffect> negativeEffect : negativeEffects) {
        ...
        // damage item
        stack.hurtAndBreak(GreekFantasy.CONFIG.UNICORN_HORN_DURABILITY_ON_USE.get(), entityLiving, EquipmentSlot.MAINHAND);
        return stack;
    }
