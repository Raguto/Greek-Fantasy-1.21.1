...
// import net.neoforged.neoforge.common.util.LazyOptional; // Removed in NeoForge 1.21 - capabilities are now attachments
...
public final class RGCompat {
    ...
    private static final ResourceLocation APOLLO = ResourceLocation.fromNamespaceAndPath("greek", "apollo");
    private static final ResourceLocation HADES = ResourceLocation.fromNamespaceAndPath("greek", "hades");
    private static final ResourceLocation HERMES = ResourceLocation.fromNamespaceAndPath("greek", "hermes");
    private static final ResourceLocation POSEIDON = ResourceLocation.fromNamespaceAndPath("greek", "poseidon");
    private static final ResourceLocation ZEUS = ResourceLocation.fromNamespaceAndPath("greek", "zeus");
