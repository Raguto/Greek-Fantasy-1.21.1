...
public class CerberusHeadModel extends Model implements HeadedModel {
    public static final ModelLayerLocation CERBERUS_HEAD_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "cerberus_head"), "cerberus_head");
