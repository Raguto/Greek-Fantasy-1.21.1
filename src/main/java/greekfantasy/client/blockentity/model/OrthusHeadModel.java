...
public class OrthusHeadModel extends Model implements HeadedModel {
    public static final ModelLayerLocation ORTHUS_HEAD_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "orthus_head"), "orthus_head");
