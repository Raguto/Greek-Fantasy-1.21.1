...
public class GiganteHeadModel extends Model implements HeadedModel {
    public static final ModelLayerLocation GIGANTE_HEAD_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "gigante_head"), "gigante_head");
