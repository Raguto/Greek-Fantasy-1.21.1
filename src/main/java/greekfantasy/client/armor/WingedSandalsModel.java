...
public class WingedSandalsModel extends HumanoidModel<LivingEntity> {
    ...
    public static final ModelLayerLocation WINGED_SANDALS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "winged_sandals"), "winged_sandals");
    ;
    ...
    public void setupWingsAnim(LivingEntity entity) {
        // 1.21: getFrameTime() moved to getTimer().getGameTimeDeltaPartialTick()
        float ageInTicks = entity.tickCount + Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(true);
        // animate wings
