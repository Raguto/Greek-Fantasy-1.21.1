...
public class GorgonParticle extends Particle {
    ...
    public void render(VertexConsumer buffer, Camera renderInfo, float partialTick) {
        ...
        this.model.getHead().render(poseStack, vertexconsumer, LightTexture.FULL_BRIGHT, OverlayTexture.NO_OVERLAY, -1);
        multibuffersource$buffersource.endBatch();
    }

    // 1.21: shouldCull() removed - use getRenderBoundingBox() instead
    // Return AABB.INFINITE to disable culling
    @Override
