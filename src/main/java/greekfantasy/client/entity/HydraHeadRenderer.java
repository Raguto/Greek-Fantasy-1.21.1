...
public class HydraHeadRenderer<T extends HydraHead> extends MobRenderer<T, HydraHeadModel<T>> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/hydra/hydra_head.png");
    private static final ResourceLocation TEXTURE_CHARRED = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/hydra/hydra_head_charred.png");
