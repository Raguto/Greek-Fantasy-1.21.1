...
public class GorgonRenderer<T extends Gorgon> extends MobRenderer<T, GorgonModel<T>> {
    ...
    public static final ResourceLocation GORGON_TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/gorgon/gorgon.png");
    public static final ResourceLocation MEDUSA_TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/gorgon/medusa.png");
