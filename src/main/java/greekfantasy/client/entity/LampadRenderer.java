...
public class LampadRenderer<T extends Lampad> extends MobRenderer<T, NymphModel<T>> {
    ...
    static {
        TEXTURE_MAP.put(Lampad.Variant.CRIMSON, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/lampad/crimson.png"));
        TEXTURE_MAP.put(Lampad.Variant.WARPED, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/lampad/warped.png"));
        TEXTURE_MAP.put(Lampad.Variant.POMEGRANATE, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/lampad/pomegranate.png"));
    }
