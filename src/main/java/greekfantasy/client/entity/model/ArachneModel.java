...
public class ArachneModel<T extends Arachne> extends HumanoidModel<T> {
    public static final ModelLayerLocation ARACHNE_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "arachne"), "arachne");
