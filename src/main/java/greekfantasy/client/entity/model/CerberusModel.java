...
public class CerberusModel<T extends Cerberus> extends AgeableListModel<T> {
    public static final ModelLayerLocation CERBERUS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "cerberus"), "cerberus");
    ...
    @Override
    public void renderToBuffer(final PoseStack matrixStackIn, final VertexConsumer vertexBuilder, final int packedLightIn, final int packedOverlayIn, final int color) {
