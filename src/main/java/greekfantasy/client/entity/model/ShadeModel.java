...
public class ShadeModel<T extends Shade> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation SHADE_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "shade"), "shade");
    ;
