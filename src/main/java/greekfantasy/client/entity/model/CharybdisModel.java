...
public class CharybdisModel extends AgeableListModel<Charybdis> {
    ...
    public static final ModelLayerLocation CHARYBDIS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "charybdis"), "charybdis");
    ...
    public void setupArmAnim(Charybdis entity, float ageInTicks) {
        ...
        for (int i = 0, n = armList.size(); i < n; i++) {
            ...
            GFModelUtil.setupCharybdisArmAnim(arm.left, arm.middle, arm.right, idleSwing, throwingTimeLeft, throwingZ);
        }
    }
