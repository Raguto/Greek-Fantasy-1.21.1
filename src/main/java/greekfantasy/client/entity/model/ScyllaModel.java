...
public class ScyllaModel extends HumanoidModel<Scylla> {
    ...
    public static final ModelLayerLocation SCYLLA_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "scylla"), "scylla");
