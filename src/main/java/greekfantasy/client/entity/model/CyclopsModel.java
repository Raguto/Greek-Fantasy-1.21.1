...
public class CyclopsModel<T extends LivingEntity> extends GiganteModel<T> {
    ...
    public static final ModelLayerLocation CYCLOPS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "cyclops"), "cyclops");
