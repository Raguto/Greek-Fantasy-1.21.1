...
public class UnicornModel<T extends Unicorn> extends HorseModel<T> {
    public static final ModelLayerLocation UNICORN_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "unicorn"), "unicorn");
