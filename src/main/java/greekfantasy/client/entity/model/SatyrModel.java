...
public class SatyrModel<T extends Satyr> extends HoofedHumanoidModel<T> {
    public static final ModelLayerLocation SATYR_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "satyr"), "satyr");
	public static final ModelLayerLocation SATYR_INNER_ARMOR_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "satyr_inner_armor"), "satyr_inner_armor");
