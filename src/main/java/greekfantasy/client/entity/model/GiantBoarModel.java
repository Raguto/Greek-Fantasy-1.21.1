...
public class GiantBoarModel<T extends GiantBoar> extends HoglinModel<T> {
    ...
    @Override
    public void renderToBuffer(final PoseStack poseStack, final VertexConsumer vertexConsumer, final int packedLightIn, final int packedOverlayIn, final int color) {
