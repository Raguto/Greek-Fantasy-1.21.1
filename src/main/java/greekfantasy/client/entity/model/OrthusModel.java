...
public class OrthusModel<T extends Orthus> extends AgeableListModel<T> {
	public static final ModelLayerLocation ORTHUS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "orthus"), "orthus");
