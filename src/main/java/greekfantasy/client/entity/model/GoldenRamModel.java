...
public class GoldenRamModel<T extends GoldenRam> extends SheepModel<T> {
    public static final ModelLayerLocation RAM_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "ram"), "ram");
    ...
    public void renderHorns(final PoseStack poseStack, final VertexConsumer vertexConsumer, final int packedLight, final int packedOverlay) {
        horns.copyFrom(head);
        horns.render(poseStack, vertexConsumer, packedLight, packedOverlay);
    }
