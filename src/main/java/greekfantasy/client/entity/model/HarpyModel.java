...
public class HarpyModel<T extends Harpy> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation HARPY_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "harpy"), "harpy");
    ;
