...
public class SpellModel<T extends Projectile> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation SPELL_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "spell"), "spell");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        this.root.render(poseStack, vertexConsumer, usePackedLight ? packedLight : LightTexture.FULL_BRIGHT, packedOverlay, color);
    }
