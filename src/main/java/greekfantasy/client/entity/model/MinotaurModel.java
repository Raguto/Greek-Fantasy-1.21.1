...
public class MinotaurModel<T extends Minotaur> extends HoofedHumanoidModel<T> {
    public static final ModelLayerLocation MINOTAUR_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "minotaur"), "minotaur");
