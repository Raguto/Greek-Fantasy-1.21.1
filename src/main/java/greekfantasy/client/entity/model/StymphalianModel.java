...
public class StymphalianModel<T extends Stymphalian> extends HierarchicalModel<T> {
    public static final ModelLayerLocation STYMPHALIAN_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "stymphalian"), "stymphalian");
