...
public class NymphModel<T extends PathfinderMob> extends HumanoidModel<T> {
    public static final ModelLayerLocation NYMPH_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "nymph"), "nymph");
