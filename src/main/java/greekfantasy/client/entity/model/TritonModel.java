...
public class TritonModel<T extends PathfinderMob> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation TRITON_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "triton"), "triton");
