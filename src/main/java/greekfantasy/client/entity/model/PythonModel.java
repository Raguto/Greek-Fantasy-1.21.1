...
public class PythonModel<T extends Python> extends AgeableListModel<T> {
    ...
    public static final ModelLayerLocation PYTHON_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "python"), "python");
