...
public class HydraBodyModel<T extends Hydra> extends EntityModel<T> {
    public static final ModelLayerLocation HYDRA_BODY_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "hydra_body"), "hydra_body");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLightIn, int packedOverlayIn, int color) {
        body.render(poseStack, vertexConsumer, packedLightIn, packedOverlayIn, color);
    }
}
