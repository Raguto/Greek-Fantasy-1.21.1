...
public class HalfHorseModel<T extends LivingEntity & HasHorseVariant> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation HALF_HORSE_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "half_horse"), "half_horse");
