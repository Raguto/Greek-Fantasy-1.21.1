...
public class ElpisModel<T extends Elpis> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
	public static final ModelLayerLocation ELPIS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "elpis"), "elpis");
