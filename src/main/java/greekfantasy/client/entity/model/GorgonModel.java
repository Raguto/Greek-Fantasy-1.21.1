...
public class GorgonModel<T extends Gorgon> extends DrakainaModel<T> {
    ...
    public static final ModelLayerLocation GORGON_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "gorgon"), "gorgon");
