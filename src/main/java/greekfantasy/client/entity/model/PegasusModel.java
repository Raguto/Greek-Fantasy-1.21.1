...
public class PegasusModel<T extends Pegasus> extends HorseModel<T> {
    public static final ModelLayerLocation PEGASUS_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "pegasus"), "pegasus");
