...
public class CerastesModel<T extends Cerastes> extends AgeableListModel<T> {
    public static final ModelLayerLocation CERASTES_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "cerastes"), "cerastes");
