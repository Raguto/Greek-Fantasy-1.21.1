...
public class SirenModel<T extends Siren> extends TritonModel<T> {
    ...
    public static final ModelLayerLocation SIREN_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "siren"), "siren");
