...
public class BabySpiderModel<T extends BabySpider> extends SpiderModel<T> {
	public static final ModelLayerLocation BABY_SPIDER_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "baby_spider"), "baby_spider");
