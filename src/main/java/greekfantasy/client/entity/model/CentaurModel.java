...
public class CentaurModel<T extends Mob & HasHorseVariant> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation CENTAUR_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "centaur"), "centaur");
