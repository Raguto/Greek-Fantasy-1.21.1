...
public class EmpusaModel<T extends Empusa> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation EMPUSA_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "empusa"), "empusa");
