...
public class CyprianModel<T extends Mob & HasHorseVariant> extends CentaurModel<T> {
    ...
    public static final ModelLayerLocation CYPRIAN_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "cyprian"), "cyprian");
