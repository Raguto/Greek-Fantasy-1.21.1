...
public class NemeanLionModel<T extends NemeanLion> extends BigCatModel<T> {
    public static final ModelLayerLocation NEMEAN_LION_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "lion"), "lion");
