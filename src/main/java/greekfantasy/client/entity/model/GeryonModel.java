...
public class GeryonModel<T extends Geryon> extends GiganteModel<T> {
    public static final ModelLayerLocation GERYON_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "geryon"), "geryon");
    public static final ModelLayerLocation GERYON_ARMOR_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "geryon_armor"), "geryon_armor");
