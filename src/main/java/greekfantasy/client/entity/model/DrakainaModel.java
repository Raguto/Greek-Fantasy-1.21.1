...
public class DrakainaModel<T extends Mob> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation DRAKAINA_MODEL_RESOURCE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "drakaina"), "drakaina");
