...
public abstract class SpellRenderer<T extends Projectile> extends EntityRenderer<T> {
    ...
    public static class CurseRenderer extends SpellRenderer<Curse> {
        ...
        private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/curse.png");
    ...
    public static class CurseOfCirceRenderer extends SpellRenderer<CurseOfCirce> {
        ...
        private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/curse_of_circe.png");
    ...
    public static class HealingSpellRenderer extends SpellRenderer<HealingSpell> {
        ...
        private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/healing_spell.png");
    ...
    public static class PoisonSpitRenderer extends SpellRenderer<PoisonSpit> {
        ...
        private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/poison_spit.png");
    ...
    public static class WaterSpellRenderer extends SpellRenderer<WaterSpell> {
        ...
        private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/water_spell.png");
