...
public class EmpusaRenderer<T extends Empusa> extends HumanoidMobRenderer<T, EmpusaModel<T>> {
    private static final ResourceLocation TEXTURE_IDLE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/empusa/empusa.png");
    private static final ResourceLocation TEXTURE_ATTACKING = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/empusa/empusa_attacking.png");
