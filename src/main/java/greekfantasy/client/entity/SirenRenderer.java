...
public class SirenRenderer<T extends Siren> extends HumanoidMobRenderer<T, SirenModel<T>> {
    ...
    private static final ResourceLocation TEXTURE_IDLE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/siren/siren.png");
    private static final ResourceLocation TEXTURE_ATTACKING = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/siren/siren_attacking.png");
