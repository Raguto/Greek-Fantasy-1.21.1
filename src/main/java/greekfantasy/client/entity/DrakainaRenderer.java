...
public class DrakainaRenderer<T extends Drakaina> extends MobRenderer<T, DrakainaModel<T>> {
    ...
    static {
        TEXTURE_MAP.put(Drakaina.Variant.GREEN, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/drakaina/green.png"));
        TEXTURE_MAP.put(Drakaina.Variant.BROWN, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/drakaina/brown.png"));
        TEXTURE_MAP.put(Drakaina.Variant.RED, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/drakaina/red.png"));
    }
