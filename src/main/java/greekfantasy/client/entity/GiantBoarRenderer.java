...
public class GiantBoarRenderer<T extends GiantBoar> extends MobRenderer<T, GiantBoarModel<T>> {
    ...
    private static final ResourceLocation HOGLIN_TEXTURE = ResourceLocation.withDefaultNamespace("textures/entity/hoglin/hoglin.png");
    private static final ResourceLocation GIANT_BOAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/giant_boar.png");
