...
public class HalfHorseLayer<T extends LivingEntity & HasHorseVariant, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    static {
        BODY_TEXTURES.put(Variant.BLACK, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_black.png"));
        BODY_TEXTURES.put(Variant.BROWN, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_brown.png"));
        BODY_TEXTURES.put(Variant.CHESTNUT, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_chestnut.png"));
        BODY_TEXTURES.put(Variant.CREAMY, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_creamy.png"));
        BODY_TEXTURES.put(Variant.DARK_BROWN, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_darkbrown.png"));
        BODY_TEXTURES.put(Variant.GRAY, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_gray.png"));
        BODY_TEXTURES.put(Variant.WHITE, ResourceLocation.fromNamespaceAndPath("minecraft", "textures/entity/horse/horse_white.png"));
    }
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, T entity,
        ...
        layerModel.renderToBuffer(poseStack, vertexConsumer, packedLight, packedOverlay, -1);
    }
