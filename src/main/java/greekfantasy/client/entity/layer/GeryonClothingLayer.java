...
public class GeryonClothingLayer<T extends Geryon, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private static final ResourceLocation GERYON_CLOTHES_TEXTURE = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/geryon/geryon_overlay.png");
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, T entity,
        ...
        coloredCutoutModelCopyLayerRender(getParentModel(), this.layerModel, GERYON_CLOTHES_TEXTURE, poseStack, multiBufferSource, packedLight, entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, partialTick, -1);
    }
}
