...
public class PegasusWingLayer<T extends Pegasus> extends RenderLayer<T, PegasusModel<T>> {
    ...
    static {
        WING_TEXTURE_MAP.put(Variant.BLACK, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/black.png"));
        WING_TEXTURE_MAP.put(Variant.BROWN, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/brown.png"));
        WING_TEXTURE_MAP.put(Variant.CHESTNUT, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/chestnut.png"));
        WING_TEXTURE_MAP.put(Variant.CREAMY, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/creamy.png"));
        WING_TEXTURE_MAP.put(Variant.DARK_BROWN, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/darkbrown.png"));
        WING_TEXTURE_MAP.put(Variant.GRAY, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/gray.png"));
        WING_TEXTURE_MAP.put(Variant.WHITE, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/pegasus/white.png"));
    }
