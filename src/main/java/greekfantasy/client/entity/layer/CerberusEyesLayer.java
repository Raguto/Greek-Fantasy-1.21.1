...
public class CerberusEyesLayer<T extends Cerberus> extends EyesLayer<T, CerberusModel<T>> {
    ...
    private static final RenderType RENDER_TYPE = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/cerberus/cerberus_eyes.png"));
