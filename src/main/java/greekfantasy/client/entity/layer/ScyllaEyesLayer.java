...
public class ScyllaEyesLayer extends EyesLayer<Scylla, ScyllaModel> {
    ...
    private static final RenderType RENDER_TYPE = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/scylla/scylla_eyes.png"));
