...
public class TalosCrackinessLayer<T extends Talos, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private static final ResourceLocation[] CRACKINESS = {
            ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/talos/talos_crackiness_high.png"),
            ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/talos/talos_crackiness_medium.png"),
            ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/talos/talos_crackiness_low.png")
    };
