...
public class NaiadRenderer<T extends Naiad> extends MobRenderer<T, NymphModel<T>> {
    ...
    static {
        TEXTURE_MAP.put(Naiad.Variant.RIVER, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/naiad/river.png"));
        TEXTURE_MAP.put(Naiad.Variant.OCEAN, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "textures/entity/naiad/ocean.png"));
    }
