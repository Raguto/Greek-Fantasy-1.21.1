...
public class PomegranateSaplingBlock extends SaplingBlock {
    ...
    public PomegranateSaplingBlock(TreeGrower treeIn, Properties properties) {
    ...
    public void advanceTree(ServerLevel world, BlockPos pos, BlockState state, RandomSource rand) {
        if (state.getValue(STAGE) == 0) {
            ...
            if (Level.NETHER.equals(world.dimension())) {
                ...
                world.explode(null, null, null, pos.getX(), pos.getY(), pos.getZ(), 2.0F, true, Level.ExplosionInteraction.TNT);
            }
        }
    }
