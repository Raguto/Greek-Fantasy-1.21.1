...
public class LocStructureProcessor extends StructureProcessor {
    ...
    public static final LocStructureProcessor REQUIRE_AIR = new LocStructureProcessor(new BlockMatchTest(Blocks.AIR));
    ...
    protected StructureProcessorType<?> getType() {
        return GFRegistry.StructureProcessorReg.LOC_PROCESSOR_HOLDER.get();
    }
}
