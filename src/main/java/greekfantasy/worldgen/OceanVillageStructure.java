...
public class OceanVillageStructure extends Structure {
    ...
    public static final MapCodec<OceanVillageStructure> CODEC = RecordCodecBuilder.<OceanVillageStructure>mapCodec(instance ->
            ...
            ).apply(instance, OceanVillageStructure::new));
    ...
    public Optional<GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        return JigsawPlacement.addPieces(context, this.startPool, this.startJigsawName, this.maxDepth, blockpos, false, this.projectStartToHeightmap, this.maxDistanceFromCenter, PoolAliasLookup.EMPTY, DimensionPadding.ZERO, LiquidSettings.APPLY_WATERLOGGING);
    }
