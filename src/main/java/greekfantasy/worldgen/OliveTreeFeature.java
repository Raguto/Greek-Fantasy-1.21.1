...
public class OliveTreeFeature extends Feature<TreeConfiguration> {
    ...
    private static final ResourceLocation[] OLIVE_TREES = {
            ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "olive_tree/olive_tree_0"),
            ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "olive_tree/olive_tree_1"),
            ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "olive_tree/olive_tree_2")
    };
