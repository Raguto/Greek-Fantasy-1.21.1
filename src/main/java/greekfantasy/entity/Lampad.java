...
public class Lampad extends Dryad {
    ...
    protected static final TagKey<Item> LAMPAD_TRADES = ItemTags.create(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "lampad_trade"));
    ...
    public static class Variant extends Dryad.Variant {
        public static final Variant CRIMSON = new Lampad.Variant("crimson", ResourceLocation.fromNamespaceAndPath("forge", "has_structure/huge_crimson_fungus"), () -> Blocks.CRIMSON_FUNGUS);
        public static final Variant WARPED = new Lampad.Variant("warped", ResourceLocation.fromNamespaceAndPath("forge", "has_structure/huge_warped_fungus"), () -> Blocks.WARPED_FUNGUS);
        public static final Variant POMEGRANATE = new Lampad.Variant(GreekFantasy.MODID, "pomegranate",
                TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("forge", "is_nether_forest")),
        ...
        protected Variant(final String nameIn, final ResourceLocation biomeTag, final Supplier<Block> saplingIn) {
            this("minecraft", nameIn, TagKey.create(Registries.BIOME, biomeTag), "lampad", "stems", saplingIn);
        }

        protected Variant(final String modid, final String nameIn, final ResourceLocation biomeTag, final Supplier<Block> saplingIn) {
            this(modid, nameIn, TagKey.create(Registries.BIOME, biomeTag), "lampad", "stems", saplingIn);
        }
