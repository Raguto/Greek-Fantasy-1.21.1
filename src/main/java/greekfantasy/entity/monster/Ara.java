...
public class Ara extends PathfinderMob implements NeutralMob {
    ...
    protected void registerGoals() {
        ...
        if(GreekFantasy.CONFIG.ARA_SEEK_CAMP.get()) {
            this.goalSelector.addGoal(4, new MoveToStructureGoal(this, 1.0D, 3, 8, 4, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "ara_camp"), DefaultRandomPos::getPos));
        }
    ...
    public void aiStep() {
        ...
        if (this.isAggressive()) {
            if (this.getItemInHand(InteractionHand.MAIN_HAND).isEmpty()) {
                ...
                this.playSound(SoundEvents.ARMOR_EQUIP_IRON.value(), 1.2F, 1.0F);
            }
