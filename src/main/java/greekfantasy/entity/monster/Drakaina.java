...
public class Drakaina extends Monster {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(DATA_VARIANT, Variant.GREEN.getId());
    }
                ...
                if (!itemstack.isEmpty()) {
                    if (itemstack.isDamageableItem()) {
                        ...
                        if (itemstack.getDamageValue() >= itemstack.getMaxDamage()) {
                            // 1.21: broadcastBreakEvent removed - use onEquippedItemBroken instead
    ...
    protected net.minecraft.resources.ResourceKey<net.minecraft.world.level.storage.loot.LootTable> getDefaultLootTable() {
        return net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, this.getVariant().getLootTable());
    }
    ...
    public boolean doHurtTarget(final Entity entity) {
        if (super.doHurtTarget(entity)) {
            ...
            if (entity instanceof LivingEntity living) {
                ...
                switch (variant) {
                    case RED:
                        living.igniteForSeconds(2 + random.nextInt(4));
                        break;
                    case BROWN:
    ...
    public enum Variant implements StringRepresentable {
        GREEN("green", TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "has_spawn/green_drakaina"))),
        BROWN("brown", TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "has_spawn/brown_drakaina"))),
        RED("red", TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "has_spawn/red_drakaina")));
        ...
        Variant(final String name, final TagKey<Biome> biomeTag) {
            this.name = name;
            this.lootTable = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "entities/drakaina/" + this.name);
