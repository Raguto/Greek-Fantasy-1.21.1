...
public class Dryad extends PathfinderMob implements NeutralMob, TradingMob {
    ...
    protected static final TagKey<Item> DRYAD_TRADE = ItemTags.create(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "dryad_trade"));
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(DATA_VARIANT, Variant.OAK.getSerializedName());
    }
    ...
    public boolean isInvulnerableTo(final DamageSource source) {
        ...
        if (source == damageSources().inWall() && this.isHiding()) {
            return true;
        }
    ...
    protected net.minecraft.resources.ResourceKey<net.minecraft.world.level.storage.loot.LootTable> getDefaultLootTable() {
        return net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, this.getVariant().getDeathLootTable());
    }
    ...
    public boolean tryExitTree() {
        if (this.treePos != null && this.isWithinDistanceOfTree(2.0D) && this.getNavigation().isDone()) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                // 1.21: EntityType.getAABB removed - use dimensions to make AABB
                if (level().noCollision(this, this.makeBoundingBox().move(x - this.getX(), y - this.getY(), z - this.getZ()))) {
    ...
    public static class Variant implements NymphVariant {
        public static final Variant ACACIA = new Variant("acacia", ResourceLocation.fromNamespaceAndPath("forge", "is_savanna"), () -> Blocks.ACACIA_SAPLING);
        public static final Variant BIRCH = new Variant("birch", ResourceLocation.fromNamespaceAndPath("forge", "is_birch"), () -> Blocks.BIRCH_SAPLING);
        public static final Variant DARK_OAK = new Variant("dark_oak", ResourceLocation.fromNamespaceAndPath("forge", "is_spooky"), () -> Blocks.DARK_OAK_SAPLING);
        public static final Variant JUNGLE = new Variant("jungle", ResourceLocation.fromNamespaceAndPath("minecraft", "is_jungle"), () -> Blocks.JUNGLE_SAPLING);
        public static final Variant OAK = new Variant("oak", ResourceLocation.fromNamespaceAndPath("forge", "is_plains"), () -> Blocks.OAK_SAPLING);
        public static final Variant SPRUCE = new Variant("spruce", ResourceLocation.fromNamespaceAndPath("minecraft", "is_taiga"), () -> Blocks.SPRUCE_SAPLING);
        public static final Variant OLIVE = new Variant(GreekFantasy.MODID, "olive", ResourceLocation.fromNamespaceAndPath("forge", "is_olive"), () -> GFRegistry.BlockReg.OLIVE_SAPLING.get());
        ...
        protected Variant(final String nameIn, final ResourceLocation biomeTag, final Supplier<Block> saplingIn) {
            this("minecraft", nameIn, TagKey.create(Registries.BIOME, biomeTag), "dryad", "logs", saplingIn);
        }

        protected Variant(final String modid, final String nameIn, final ResourceLocation biomeTag, final Supplier<Block> saplingIn) {
            this(modid, nameIn, TagKey.create(Registries.BIOME, biomeTag), "dryad", "logs", saplingIn);
        }
        ...
        protected Variant(final String modid, final String nameIn, final TagKey<Biome> biome,
            ...
            this.deathLootTable = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "entities/" + entityIn + "/" + name);
            this.tradeLootTable = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "gameplay/" + entityIn + "_trade");
            ResourceLocation tagId = ResourceLocation.fromNamespaceAndPath(modid, name + "_" + tagSuffixIn);
            this.tag = TagKey.create(BuiltInRegistries.BLOCK.key(), tagId);
        }
