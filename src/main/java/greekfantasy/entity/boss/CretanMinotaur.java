...
public class CretanMinotaur extends Minotaur implements RangedAttackMob {
    ...
    // TODO 1.21: populateDefaultEquipmentEnchantments signature changed to include ServerLevelAccessor parameter
    //@Override
    protected void populateDefaultEquipmentEnchantments(RandomSource randomSource, DifficultyInstance difficulty) {
        // TODO 1.21: enchantSpawnedWeapon removed - need to manually enchant weapon if needed
        // this.enchantSpawnedWeapon(randomSource, 3.25F);
    }
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        ...
        this.playSound(SoundEvents.TRIDENT_THROW.value(), 1.2F, 1.2F + this.random.nextFloat() * 0.2F);
    }
