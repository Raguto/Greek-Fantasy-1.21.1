...
public class Centaur extends PathfinderMob implements NeutralMob, RangedAttackMob, HasHorseVariant, TradingMob {
    ...
    protected static final TagKey<Item> CENTAUR_TRADE = ItemTags.create(ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "centaur_trade"));
    ...
    protected void addCentaurGoals() {
        ...
        if (GreekFantasy.CONFIG.CENTAUR_SEEK_CAMP.get()) {
            this.goalSelector.addGoal(4, new MoveToStructureGoal(this, 1.0D, 3, 8, 4, ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "centaur_camp"), DefaultRandomPos::getPos));
        }
    }
    ...
    public ResourceLocation getTradeLootTable() {
        // 1.21: LootTables.EMPTY is now BuiltInLootTables.EMPTY or just use a placeholder
        return net.minecraft.world.level.storage.loot.BuiltInLootTables.EMPTY.location();
    }
