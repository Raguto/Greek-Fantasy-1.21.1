...
public class Sparti extends TamableAnimal implements RangedAttackMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1.0D, 16.0F, 5.0F));
    ...
    // Original implementation returned spawningSize when isSpawning()
    ...
    // TODO 1.21: getStandingEyeHeight(Pose, EntityDimensions) removed - eye height is now handled via EntityType builder
    //@Override
    protected float getStandingEyeHeight(Pose pose, EntityDimensions dimensions) {
        return this.isSpawning() ? 0.05F : dimensions.eyeHeight();
    }

    // Note: getMyRidingOffset removed in 1.21 - riding offset is now handled via EntityType builder
