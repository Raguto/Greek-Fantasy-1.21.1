...
public class Naiad extends PathfinderMob implements RangedAttackMob, NeutralMob {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(DATA_VARIANT, Variant.OCEAN.getSerializedName());
    }
    ...
    public void baseTick() {
        ...
        super.baseTick();
        // Restore air supply to prevent drowning - naiads can breathe underwater
        if (this.isInWater()) {
            this.setAirSupply(i);
        }
    }
    ...
    public void tick() {
        ...
        if (!level().isClientSide() && level() instanceof ServerLevel serverLevel
                ...
                && this.hasEffect(GFRegistry.MobEffectReg.CURSE_OF_CIRCE)) {
            // spawn scylla
    ...
    // Note: getDimensions is now final in 1.21 - entity dimensions are handled via EntityType builder
    // The swimming dimensions are handled by the pose system automatically
    ...
    // Note: canBreatheUnderwater() is now final in 1.21
    // Water breathing is handled via entity type definition or decreaseAirSupply override
...
*/
    ...
    public static class Variant implements StringRepresentable {
        public static final Variant RIVER = new Naiad.Variant("river", ResourceLocation.fromNamespaceAndPath("minecraft", "is_river"));
        public static final Variant OCEAN = new Naiad.Variant("ocean", ResourceLocation.fromNamespaceAndPath("minecraft", "is_ocean"));
        ...
        protected Variant(final String nameIn, final ResourceLocation biomeTag) {
            this.name = nameIn;
            this.biomeTag = TagKey.create(Registries.BIOME, biomeTag);
            this.deathLootTable = ResourceLocation.fromNamespaceAndPath(GreekFantasy.MODID, "entities/naiad/" + name);
        }
