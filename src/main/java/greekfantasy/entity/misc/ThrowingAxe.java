...
public class ThrowingAxe extends ThrowableItemProjectile {
    ...
    public void setItem(ItemStack itemStack) {
        ...
        if(itemStack.getItem() instanceof DiggerItem diggerItem) {
            // 1.21: getAttackDamage() removed from DiggerItem, use tier's attack damage bonus instead
            setBaseDamage(diggerItem.getTier().getAttackDamageBonus());
        }
    }
    ...
    protected void onHitEntity(EntityHitResult raytrace) {
        ...
        // 1.21: getMobType() and EnchantmentHelper.getDamageBonus(ItemStack, MobType) removed
        // The MobType system was removed in 1.21 - damage bonuses are now handled differently
