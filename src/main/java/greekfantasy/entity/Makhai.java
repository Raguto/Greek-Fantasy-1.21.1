...
public class Makhai extends TamableAnimal {
    ...
    // Note: getStandingEyeHeight and getMyRidingOffset removed in 1.21
    // Eye height and riding offset are now handled via EntityType builder
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        setTame(compound.getBoolean(KEY_TAME), false);
    }
